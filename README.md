...
Each folder is self-contained. `cd` into a project directory and follow its README for setup and usage instructions. All projects use plain Python 3 with no external dependencies unless noted.

## ⚠️ Disclaimer

These tools are for educational purposes and authorized testing only. Do not use them against systems you don't own or don't have explicit permission to test.
